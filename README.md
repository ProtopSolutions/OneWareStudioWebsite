Changes to this repository are built daily at 0:00 UTC and uploaded to https://oneware.studio
...
2. Clone repository
```bash
git clone https://github.com/ProtopSolutions/OneWareStudioWebsite.git
```

3. Navigate to cloned directory and install node modules:
```bash
cd OneWareStudioWebsite
npm install
```
